...
# Still need to convert US Total variations to US and states to abbreviated
...
p2003['Year'] = '2003'
#for state in p2003['State']:
        
    #return p2003
    #p2003 = reading_prices_2003(dfs2003)
...
# Where and when is procedure outside of function
# Function is actions performed to DF
...
def reading_prices_1(dfs):
    ...
    for state in set(prices['State']):
        ...
        # Fix this - find a way to drop these columns for now, but then add back after adding them to other dfs
